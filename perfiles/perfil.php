...
$sql = "SELECT * FROM usuarios WHERE id_user='$tuid'";  
$res = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($res);

$sql2 = "SELECT * FROM post WHERE id_usuario='$tuid' ORDER BY fecha_publicacion DESC";
$res2 = mysqli_query($conn, $sql2);
$nfilas = mysqli_num_rows ($res2);

$follower = $row['seguidores'];
$following = $row['seguidos'];
